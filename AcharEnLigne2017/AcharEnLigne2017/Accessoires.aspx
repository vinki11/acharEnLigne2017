<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Accessoires.aspx.cs" Inherits="ListeProduit" %>

<asp:Content ID="ContentListe" ContentPlaceHolderID="contentPlaceHolderContenu" runat="server">        

        <asp:SqlDataSource ID="SqlDataSourceAccessoire" runat="server" 
            ConnectionString="<%$ ConnectionStrings:ConnectionStringAcharEnLigne2017 %>"
            SelectCommand="SELECT i.[idItem], i.[nomItem], i.[coutAchat], i.[prixVente], i.[imageItem], a.[quantite] FROM [item] i INNER JOIN [accessoire] a ON i.[idItem] = a.[idItem]">
            <%--<FilterParameters>
        ...
        <div id="listeproduits">
            <div class="grille">
                ...
                <asp:GridView ID="GridViewProduits" runat="server" DataSourceID="SqlDataSourceAccessoire" AutoGenerateEditButton="false" AutoGenerateDeleteButton="false" AutoGenerateColumns="False" HeaderStyle-CssClass="entetegrille" RowStyle-CssClass="lignesgrille" DataKeyNames="idItem">
                    <Columns>
