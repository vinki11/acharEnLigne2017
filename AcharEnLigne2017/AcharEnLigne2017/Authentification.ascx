<%--
Description : Contrôle utilisateur qui s'occupe des contrôles d'authentification
...
<div id="conneclang">
	...
	<asp:HyperLink id="hyperlinkLangue" NavigateUrl="English.aspx" Text="English" runat="server" />
</div>
<div class="row">
	<div class="12u">
	    <div id="deconnexion">
